# ibot_clip_pretrain_module_unet.py - Module for IBot pretraining using unet as backbone
...
class IBOTCLIPPretrainModuleUnet(pl.LightningModule):
    ...
    # clip loss
    # image_embeds = tensor of image embeddings from Unet encoder
