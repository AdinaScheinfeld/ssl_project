# all_datasets_clip_pretrain_updated.py - Multi-source Data Pretraining
...
from ibot_clip_pretrain_module_updated import IBOTCLIPPretrainModuleUpdated
...
if __name__ == '__main__':
    ...
    # initialize model
    model = IBOTCLIPPretrainModuleUpdated(config)
