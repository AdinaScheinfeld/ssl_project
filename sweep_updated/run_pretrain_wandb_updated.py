# sweep/run_pretrain_wandb_updated.py
...
#   /ministorage/adina/pretrain_sweep.
...
BASE_CONFIG = os.environ.get(
    "BASE_CONFIG",
    "/home/ads4015/ssl_project/configs/all_datasets_clip_pretrain_2_config_updated.yaml"
)

# training script path
TRAIN_SCRIPT = "/home/ads4015/ssl_project/sweep_updated/all_datasets_clip_pretrain_updated.py"

# base output directory for all sweep runs
BASE_OUT = os.environ.get("PRETRAIN_SWEEP_DIR", "/ministorage/adina/pretrain_sweep_updated")
...
if __name__ == "__main__":
    ...
    merged["model"]["save_filename"] = (
        "all_datasets_clip_pretrained-updated-epoch{epoch:03d}-val-report{val_loss_report:.4f}-step{step}"
    )
