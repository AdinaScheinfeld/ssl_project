# no_clip/run_pretrain_wandb_no_clip.py
...
BASE_CONFIG = os.environ.get(
    "BASE_CONFIG",
    "/home/ads4015/ssl_project/no_clip/all_datasets_pretrain_2_config_no_clip.yaml"
)

# training script path
TRAIN_SCRIPT = "/home/ads4015/ssl_project/no_clip/all_datasets_pretrain_no_clip.py"

# base output directory for all sweep runs
BASE_OUT = os.environ.get("PRETRAIN_SWEEP_DIR", "/ministorage/adina/pretrain_sweep_no_clip")
...
if __name__ == "__main__":
    ...
    merged["model"]["save_filename"] = (
        "all_datasets_pretrained_no_clip-epoch{epoch:03d}-val{val_loss:.4f}-step{step}"
    )
