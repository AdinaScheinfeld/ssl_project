# all_datasets_clip_data_module_rewrites.py - Data module for all datasets with CLIP
...
from nifti_text_patch_multi_dataset_rewrites import MultiSourceNiftiTextPatchDatasetRewrites
...
class AllDatasetsClipDataModuleRewrites(LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_ds = MultiSourceNiftiTextPatchDatasetRewrites(
        ...
        self.val_ds = MultiSourceNiftiTextPatchDatasetRewrites(
