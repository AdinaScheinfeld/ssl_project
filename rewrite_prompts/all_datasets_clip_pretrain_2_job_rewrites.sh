#!/bin/bash
#SBATCH --job-name=2clip_pretrain_rewrites
#SBATCH --output=logs/all_clip_pretrain_2_rewrites_%j.out
...
# all_datasets_clip_pretrain_2_job_rewrites.sh - Script for all datasets pretraining

# indicate starting
echo "Starting LSM pretraining with rewrites..."
...
# run script
srun --label python /home/ads4015/ssl_project/rewrite_prompts/all_datasets_clip_pretrain_rewrites.py --config $CONFIG_PATH



# indicate completion
echo 'LSM pretraining with rewrites complete'
