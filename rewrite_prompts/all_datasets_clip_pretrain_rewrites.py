# all_datasets_clip_pretrain_rewrites.py - Multi-source Data Pretraining
...
from all_datasets_clip_data_module_rewrites import AllDatasetsClipDataModuleRewrites
...
if __name__ == '__main__':
    ...
    datamodule = AllDatasetsClipDataModuleRewrites(
        roots=roots,
        enable=enable,
    ...
    # create periodic checkpoint directory if needed
    ...
    every_n = int(config['training'].get('checkpoint_every_n_epochs', 0))
    if every_n > 0:
        callbacks.append(
            ModelCheckpoint(
