...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_super_sweep2/logs/finetune_inpaint_unet_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_super_sweep2/logs/finetune_inpaint_unet_%A_%a.err
...
python /home/ads4015/ssl_project/src/finetune_inpaint_split_unet.py \
  ...
  --weight_decay 1e-5 \
  --wandb_project selma3d_inpaint_unet_super_sweep2 \
  --num_workers 1 \
  --channel_substr ALL \
  --mask_mode "$MASK_MODE" \
