#!/bin/bash
# submit_all_classification_folds3.sh
#
...
#
# Usage:
#   ./submit_all_classification_folds3.sh [FOLDS_DIR] [INIT_MODE]
#
# Examples:
#   ./submit_all_classification_folds3.sh \
...
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_eval_classification_cross_val_job_array3.sh"
