...
#SBATCH --output=logs/all_clip_pretrain_unet_2_%j.out
#SBATCH --error=logs/all_clip_pretrain_unet_2_%j.err
...
# all_datasets_clip_pretrain_2_job_unet.sh - Script for all datasets pretraining
...
export HF_HOME=/home/ads4015/.cache/huggingface
...
CONFIG_PATH="/home/ads4015/ssl_project/configs/all_datasets_clip_pretrain_2_config_unet.yaml"
...
# run script
srun --label python /home/ads4015/ssl_project/src/all_datasets_clip_pretrain_unet.py --config $CONFIG_PATH
