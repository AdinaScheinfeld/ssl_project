...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_random_ntc/logs/build_submit_inpaint_cv_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_random_ntc/logs/build_submit_inpaint_cv_%j.err
...
# /home/ads4015/ssl_project/scripts/finetune_inpaint_split_build_submit3.sh - Build and submit inpainting CV jobs
...
OUTDIR="/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_random_ntc/cv_folds" # output dir for folds and tasks
REPEATS=3
SEED=100
CHANNELS="ALL"
TEST_SIZE=2
JOB_PREFIX="random"
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_inpaint_split_job_array3.sh"
