...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_random/logs/build_submit_inpaint_cv_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_random/logs/build_submit_inpaint_cv_%j.err
...
OUTDIR="/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_random/cv_folds" # output dir for folds and tasks
REPEATS=3
SEED=100
CHANNELS="ALL"
TEST_SIZE=2
