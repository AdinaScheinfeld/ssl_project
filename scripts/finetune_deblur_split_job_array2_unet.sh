...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_bright_sweep_26/logs/finetune_deblur_unet_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_bright_sweep_26/logs/finetune_deblur_unet_%A_%a.err
...
CKPT_PRETR="/midtier/paetzollab/scratch/ads4015/pretrain_sweep_unet_no_text/checkpoints/t3cw8qnt/all_datasets_clip_pretrained_unet_best.ckpt"
