...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_unet_random/logs/build_submit_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_unet_random/logs/build_submit_%j.err
...
OUTROOT="${SCRATCH_ROOT}/temp_selma_segmentation_preds_unet_random"
