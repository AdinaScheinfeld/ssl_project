...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_unet_random2_ntc/logs/finetune_inpaint_unet_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_unet_random2_ntc/logs/finetune_inpaint_unet_%A_%a.err
...
#   --weight_decay 1e-5 \
#   --wandb_project selma3d_inpaint_unet_unet_random2_ntc \
#   --num_workers 1 \
#   --channel_substr ALL \
#   --mask_mode "$MASK_MODE" \
