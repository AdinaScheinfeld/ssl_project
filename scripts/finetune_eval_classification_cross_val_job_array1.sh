...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_autumn_sweep_27/logs/classification_cross_val_arr_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_autumn_sweep_27/logs/classification_cross_val_arr_%A_%a.err
...
bash /home/ads4015/ssl_project/scripts/finetune_eval_classification_cross_val_job1.sh "$FOLD_ID" "$FOLD_JSON" "$INIT_MODE"
