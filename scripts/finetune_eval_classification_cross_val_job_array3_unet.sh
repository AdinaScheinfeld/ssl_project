#!/bin/bash
#SBATCH --job-name=cls_unet_arr_rand
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_unet_random2/logs/cls_unet_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_unet_random2/logs/cls_unet_%A_%a.err
...
srun python /home/ads4015/ssl_project/src/finetune_and_eval_classification_split_unet.py \
  ...
  --fold_json "$FJSON" \
  --fold_id "$FID" \
  --wandb_project selma3d_classify_unet_random2 \
