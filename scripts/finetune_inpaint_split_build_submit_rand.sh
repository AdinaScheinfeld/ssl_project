#!/bin/bash
#SBATCH --job-name=build_submit_inpaint_cv_rand_ntc
#SBATCH --output=/ministorage/adina/selma_inpaint_preds_rand_ntc/logs/build_submit_inpaint_cv_rand_ntc_%j.out
#SBATCH --error=/ministorage/adina/selma_inpaint_preds_rand_ntc/logs/build_submit_inpaint_cv_rand_ntc_%j.err
...
OUTDIR="/ministorage/adina/selma_inpaint_preds_rand_ntc/cv_folds" # output dir for folds and tasks
REPEATS=3
SEED=100
CHANNELS="ALL"
TEST_SIZE=2
