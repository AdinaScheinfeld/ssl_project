#!/bin/bash
#SBATCH --job-name=build_submit_deblur_unet_cv_rand
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_unet_random2_v2/logs/build_submit_deblur_unet_cv_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_unet_random2_v2/logs/build_submit_deblur_unet_cv_%j.err
...
# *** USE THIS SCRIPT FOR RANDOM INIT UNET DEBLURRING ONLY ***
...
OUTROOT="/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_unet_random2_v2"
...
JOB_PREFIX="deblur_unet_super2v2"
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_deblur_split_job_array3_unet.sh"
MAX_CONCURRENT=""
