...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_unet_random2/logs/build_submit_cls_unet_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_unet_random2/logs/build_submit_cls_unet_%j.err
#SBATCH --partition=minilab-cpu
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=02:00:00

# *** USE THIS FILE FOR RANDOM INIT ONLY ***
...
OUTROOT="/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_unet_random2"
...
# submit GPU array
# -----------------------
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_eval_classification_cross_val_job_array3_unet.sh"
