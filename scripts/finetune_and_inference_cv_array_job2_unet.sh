...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_bright_sweep_26/logs/ft_infer_unet_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_bright_sweep_26/logs/ft_infer_unet_%A_%a.err
...
OUTROOT="/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_bright_sweep_26"
...
python /home/ads4015/ssl_project/src/finetune_and_inference_split_unet.py \
  ...
  --wandb_project selma3d_unet_ft_infer_sizes_image_only \
  --seed 100 \
  --batch_size 2 \
  --num_workers 4 \
  --val_percent 0.2 \
