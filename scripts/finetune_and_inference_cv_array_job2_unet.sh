...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_peach_sweep_25/logs/ft_infer_unet_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_peach_sweep_25/logs/ft_infer_unet_%A_%a.err
...
OUTROOT="/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_peach_sweep_25"
