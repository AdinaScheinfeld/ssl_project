...
#
# Usage:
#   ./submit_all_classification_folds1.sh [FOLDS_DIR] [INIT_MODE]
#
# Examples:
#   ./submit_all_classification_folds1.sh \
...
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_eval_classification_cross_val_job_array1.sh"
