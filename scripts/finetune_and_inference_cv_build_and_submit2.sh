...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_expert_sweep_31_v2/logs/build_submit_ft_cv_2_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_expert_sweep_31_v2/logs/build_submit_ft_cv_2_%j.err
...
OUTDIR="/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_expert_sweep_31_v2/cv_folds" # output dir for folds jsons and tasks file
REPEATS=3
SEED=100
CHANNELS="ALL"
TEST_SIZE=2
