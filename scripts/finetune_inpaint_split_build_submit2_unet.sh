...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_bright_sweep_26_ntc/logs/build_submit_inpaint_unet_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_inpaint_preds_bright_sweep_26_ntc/logs/build_submit_inpaint_unet_%j.err
...
CHANNELS="ALL"
TEST_SIZE=2
JOB_PREFIX="inpaint_unet_bright_sweep_26_ntc"
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_inpaint_split_job_array2_unet.sh"
