...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_super_sweep2/logs/cls_unet_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_super_sweep2/logs/cls_unet_%A_%a.err
...
# -----------------------
PRETRAINED_UNET="/midtier/paetzollab/scratch/ads4015/pretrain_sweep_unet/checkpoints/aaqkna34/all_datasets_clip_pretrained_unet_best.ckpt"
...
srun python /home/ads4015/ssl_project/src/finetune_and_eval_classification_split_unet.py \
  ...
  --fold_json "$FJSON" \
  --fold_id "$FID" \
  --wandb_project selma3d_classify_unet_super_sweep2 \
