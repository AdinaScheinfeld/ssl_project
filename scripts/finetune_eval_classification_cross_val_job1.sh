...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_autumn_sweep_27/logs/classification_cross_val_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_autumn_sweep_27/logs/classification_cross_val_%j.err
...
CKPT_DIR="/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_autumn_sweep_27/checkpoints/finetune_cls" # checkpoint output dir
METRICS_ROOT="/midtier/paetzollab/scratch/ads4015/temp_selma_classification_preds_autumn_sweep_27/cls_metrics" # metrics output dir
...
PRETRAINED="/midtier/paetzollab/scratch/ads4015/checkpoints/autumn_sweep_27/all_datasets_clip_pretrained-updated-epochepoch=354-val-reportval_loss_report=0.0968-stepstep=20590.ckpt" # pretrained backbone checkpoint (image only)
