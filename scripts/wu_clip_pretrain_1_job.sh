...
#SBATCH --gres=gpu:h100:1 # select number of gpus ***
#SBATCH --mem=180G
#SBATCH --cpus-per-task=16
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1 # 1 task per gpu ***

# wu_clip_pretrain_1_job.sh - Script for Wu data pretraining
...
CONFIG_PATH="/home/ads4015/ssl_project/configs/wu_clip_pretrain_1_config.yaml"
