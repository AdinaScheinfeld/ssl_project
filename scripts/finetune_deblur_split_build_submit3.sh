...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_random/logs/build_submit_deblur_cv_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_random/logs/build_submit_deblur_cv_%j.err
#SBATCH --partition=minilab-cpu
#SBATCH --cpus-per-task=2
#SBATCH --mem=4G
#SBATCH --time=02:00:00

# /home/ads4015/ssl_project/scripts/finetune_deblur_split_build_submit3.sh - build CV folds and submit deblurring finetune array jobs
...
OUTDIR="/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_random/cv_folds"
...
JOB_PREFIX="random"
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_deblur_split_job_array3.sh"
