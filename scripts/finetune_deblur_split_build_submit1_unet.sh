...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_super_sweep2_v2/logs/build_submit_deblur_unet_cv_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_deblur_preds_super_sweep2_v2/logs/build_submit_deblur_unet_cv_%j.err
...
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_deblur_split_job_array1_unet.sh"
MAX_CONCURRENT=""
