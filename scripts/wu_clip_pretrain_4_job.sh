...
#SBATCH --gres=gpu:h100:4 # select number of gpus ***
#SBATCH --mem=180G
...
# wu_clip_pretrain_4_job.sh - Script for Wu data pretraining
...
CONFIG_PATH="/home/ads4015/ssl_project/configs/wu_clip_pretrain_4_config.yaml"
