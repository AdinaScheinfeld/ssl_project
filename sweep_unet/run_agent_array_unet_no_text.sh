...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/pretrain_sweep_unet_no_text/logs/wandb_array_unet_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/pretrain_sweep_unet_no_text/logs/wandb_array_unet_%A_%a.err
...
export PRETRAIN_SWEEP_DIR="/midtier/paetzollab/scratch/ads4015/pretrain_sweep_unet_no_text"
...
export BASE_CONFIG="/home/ads4015/ssl_project/configs/all_datasets_clip_pretrain_2_config_unet_no_text.yaml"
