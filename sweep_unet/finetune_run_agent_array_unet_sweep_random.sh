...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/finetune_sweep_unet_random/logs/agent_%A_%a.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/finetune_sweep_unet_random/logs/agent_%A_%a.err
...
if [[ -z "$SWEEP_ID" ]]; then
  ...
  echo "Example: sbatch $0 adinas-wcm/selma3d_finetune_unet_stratified_random/abcd1234"
  exit 1
fi

# ---- dirs ----
export SCRATCH_ROOT="/midtier/paetzollab/scratch/ads4015"
export SWEEP_ROOT="${SCRATCH_ROOT}/finetune_sweep_unet_random"
