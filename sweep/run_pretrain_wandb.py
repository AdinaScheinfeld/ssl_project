...
BASE_CONFIG = os.environ.get(
    "BASE_CONFIG",
    "/home/ads4015/ssl_project/configs/all_datasets_clip_pretrain_2_config.yaml"
)

# training script path
TRAIN_SCRIPT = "/home/ads4015/ssl_project/src/all_datasets_clip_pretrain.py"

# base output directory for all sweep runs
BASE_OUT = os.environ.get("PRETRAIN_SWEEP_DIR", "/ministorage/adina/pretrain_sweep")
...
if __name__ == "__main__":
    ...
    merged["model"]["save_filename"] = (
        "all_datasets_clip_pretrained-epoch{epoch:03d}-val{val_loss:.4f}-step{step}"
    )
