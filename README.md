...
- Preprocessing
    ...
    - [visualize_selma3d_train_transforms.ipynb](/notebooks/visualize_selma3d_train_transforms.ipynb) - Notebook to visualize transforms for unannotated selma3d pretraining data. Also downloads patches for pretraining.<br><br>
...
- Pretraining
    ...
    - [selma3d_visualization_functions.py](/preprocess_patches/src/selma3d_visualization_functions.py) - Functions for preprocessing and pretraining files and scripts.<br><br>
...
- Finetuning
    ...
    - [selma3d_finetune_config.yaml](/configs/selma3d_finetune_config.yaml) - Config file for finetuning.<br><br>
    - [wu_transforms.py](/src/wu_transforms.py) - Transforms for pretraining and finetuning.
